...
* Nickname:	hendersj, jhenderson

* Homepage:	Haven’t really got a current one; an old one is sometimes available at [http://hendersj.dyndns.org](http://hendersj.dyndns.org) but I haven’t updated it in a couple years.
...
![Jim](images/jim_henderson_mountains.png)
...
Q: What do you like to do when you’re not working on a computer?

A: Watching TV (though I don’t watch a lot, I prefer movies), working out at the gym. I like hiking in the mountains, but it’s been a while since we’ve been able to do that – there is some amazing scenery out there. 
